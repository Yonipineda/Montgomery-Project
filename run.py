...
navbar = dbc.NavbarSimple(
    brand='Montgomery Crime Predictor',
    brand_href='/',
    children=[
        dbc.NavItem(
            ...
            html.P(
                [
                    ...
                    html.A(html.I(className='fas fa-envelope-square mr-1'),
                           href='mailto:yonipineda1010@icloud.com'),
                    html.A(html.I(className='fab fa-github-square mr-1'),
                           href='https://github.com/Yonipineda/Montgomery-Project'),
                    ...
                    html.A(html.I(className='fab fa-twitter-square mr-1'),
                           href='https://twitter.com/YonayYo'),
                ],
                className='lead'
            )
        )
